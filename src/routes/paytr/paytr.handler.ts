...
export async function generatePaytrToken(params: {
  ...
  const formParams = new URLSearchParams({
    ...
    merchant_ok_url:      `${frontendUrl}/odeme-basarili?orderNumber=${encodeURIComponent(params.orderNumber)}`,
    merchant_fail_url:    `${frontendUrl}/odeme-basarisiz?orderNumber=${encodeURIComponent(params.orderNumber)}`,
